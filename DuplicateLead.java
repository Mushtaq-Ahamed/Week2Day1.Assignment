...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		elementCompanyName.sendKeys("CSC India Pvt Ltd");
		WebElement elementFirstName = driver.findElement(By.id("createLeadForm_firstName"));
		elementFirstName.sendKeys("Mushtaq");
		...
		elementDepartmentName.sendKeys("HealthCare");
		...
		elementRenameCompanyName.sendKeys("CTS");
